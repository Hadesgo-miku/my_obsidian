[
    ...
    //基本双拼替换
    {trigger: "jx", replacement: "+", options: "mA"},
    {trigger: "jm", replacement: "-", options: "mA"},
    {trigger: "dgyu", replacement: "=", options: "mA"},
    {trigger: "ko", replacement: "($0)", options: "tmA"},
    {trigger: "vgiu", replacement: "\\mid", options: "mA"},
    ...
    // Basic operations
    {trigger: "fh", replacement: "^{2}", options: "mA"},
	{trigger: "sj", replacement: "^{3}", options: "mA"},
	{trigger: "uu", replacement: "^{$0}$1", options: "mA"},
	{trigger: "xx", replacement: "_{$0}$1", options: "mA"},
    ...
    {trigger: "xp2", replacement: "x_{n+2}", options: "mA"},
